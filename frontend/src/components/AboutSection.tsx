        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-heading font-bold text-3xl sm:text-4xl lg:text-5xl text-foreground mb-6 leading-tight">
              Hi, I'm{' '}
              <span className="text-gradient">Debraj Paul</span>
            </h2>

            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              I'm a student web developer based in Assam. I help lawyers, gyms, coaching centers and small businesses build{' '}
              <span className="text-foreground font-medium">affordable, professional websites</span>{' '}
              that generate real client inquiries.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-8">
              I understand the challenges local businesses face — that's why I offer fast delivery, transparent pricing, and direct support. No agencies, no middlemen. Just clean, effective websites that work.
            </p>

            {/* Tags */}
            <div className="flex flex-wrap gap-2 mb-8">
              {['React', 'Responsive Design', 'SEO Basics', 'WhatsApp Integration', 'Fast Delivery'].map((tag) => (
                <span
                  key={tag}
