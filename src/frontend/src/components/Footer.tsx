import { Code2, Heart, Mail, MessageCircle, Phone } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Student web developer from Assam, India. Building affordable,
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-heading font-semibold text-foreground mb-5">
              Quick Links
            </h4>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          >
            ...
            <Heart
              ...
              style={{ color: "hsl(var(--card))", fill: "hsl(var(--card))" }}
            />{" "}
            using{" "}
            <a
