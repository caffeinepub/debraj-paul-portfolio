...
const projects = [
  {
    ...
    description:
      "High-energy fitness website with class schedules, membership plans, and WhatsApp booking integration.",
  ...
  },
  {
    ...
    description:
      "Professional legal services website with practice areas, consultation booking, and trust-building design.",
  ...
  },
  {
    ...
    description:
      "Motivational coaching center website with course listings, testimonials, and enrollment CTAs.",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-heading font-bold text-3xl sm:text-4xl lg:text-5xl text-foreground mb-4">
            Sample <span className="text-gradient">Demo Projects</span>
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Here are some sample designs I've created for different business
            types.
          </p>
        </div>
          ...
          <div className="inline-flex items-center gap-3 px-6 py-4 bg-card border border-border rounded-2xl">
            ...
            <p className="text-muted-foreground">
              <span className="text-foreground font-medium">
                Demo designs available on request.
              </span>{" "}
