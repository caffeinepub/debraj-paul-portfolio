  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden hero-gradient">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(oklch(0.62 0.18 230 / 0.3) 1px, transparent 1px), linear-gradient(90deg, oklch(0.62 0.18 230 / 0.3) 1px, transparent 1px)",
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        <h1 className="font-heading font-black text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight mb-6 animate-fade-up">
          Professional Business <span className="text-gradient">Websites</span>
          <br />
          in{" "}
          <span className="relative inline-block">
            ...
            <span
              ...
              style={{
                background:
                  "linear-gradient(90deg, oklch(0.62 0.18 230), oklch(0.75 0.15 200))",
              }}
            />
          </span>
        </h1>
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-up">
          ...
          <span className="text-foreground font-medium">
            modern, mobile-optimized websites.
          </span>
        </p>
