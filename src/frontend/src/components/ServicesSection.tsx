import { Globe, Layers, MessageCircle, RefreshCw, Search } from "lucide-react";
...
const services = [
  {
    ...
    description:
      "Professional, modern websites tailored to your business needs and brand identity.",
    color: "text-blue-400",
    bg: "bg-blue-400/10",
  ...
  },
  {
    ...
    title: "Landing Pages",
    description:
      "High-converting single-page designs focused on capturing leads and driving action.",
  ...
  },
  {
    ...
    description:
      "Transform your outdated website into a modern, mobile-friendly experience.",
    color: "text-cyan-400",
    bg: "bg-cyan-400/10",
  ...
  },
  {
    ...
    description:
      "Direct inquiry buttons so clients can reach you instantly via WhatsApp or phone.",
  ...
  },
  {
    ...
    description:
      "On-page SEO optimization to help your business get found on Google locally.",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Everything you need to establish a strong online presence and start
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                {/* Hover accent line */}
                <div
                  className={`absolute bottom-0 left-6 right-6 h-0.5 rounded-full ${service.bg} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                />
              </div>
            );
          })}
